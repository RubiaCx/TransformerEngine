...
def per_block_e5m2(q, k, v, BLKQ=128, BLKK=64, BLKV=64, sm_scale=None, tensor_layout="bhsd"):
    ...
    return q_e5m2, q_scale, k_e5m2, k_scale, v_e5m2, v_scale